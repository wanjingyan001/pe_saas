...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#f7f9fc");
    private static int COLOR_TITLE_FONT = Color.parseColor("#a0a4aa");
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), child.getPaddingLeft() + Utils.dip2px(context,20.0f), child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {//最后调用 绘制在最上层
        ...
        c.drawText(tag, child.getPaddingLeft()+ Utils.dip2px(context,20.0f),
