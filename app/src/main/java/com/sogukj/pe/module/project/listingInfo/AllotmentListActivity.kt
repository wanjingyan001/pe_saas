 ...
 */
class AllotmentListActivity : BaseRefreshActivity(), SupportEmptyView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = RecyclerAdapter(this, { _adapter, parent, type ->
            val convertView = _adapter.getView(R.layout.item_project_allotment, parent)
            object : RecyclerHolder<AllotmentBean>(convertView) {

                var tvIssueDate = convertView.findViewById<TextView>(R.id.tv_issueDate) as TextView
                var tvName = convertView.findViewById<TextView>(R.id.tv_name) as TextView
                var tvProgress = convertView.findViewById<TextView>(R.id.tv_progress) as TextView
