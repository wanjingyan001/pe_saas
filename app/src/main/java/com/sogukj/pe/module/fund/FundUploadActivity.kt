...
import com.sogukj.pe.module.fund.FundListFragment.Companion.TYPE_CB
import com.sogukj.pe.module.fund.FundListFragment.Companion.TYPE_CX
import com.sogukj.pe.module.fund.FundListFragment.Companion.TYPE_TC
...
class FundUploadActivity : ToolbarActivity() {
    ...
    inner class UploadAdapter(val context: Context, val uploadList: List<UploadBean>) : RecyclerView.Adapter<UploadAdapter.FileHolder>() {
        ...
        override fun getItemViewType(position: Int): Int {
            return if (uploadList[position].isSuccess) 0 else 1
        }
