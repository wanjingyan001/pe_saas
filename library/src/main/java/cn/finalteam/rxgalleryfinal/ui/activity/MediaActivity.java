    ...
    private void subscribeEvent() {
        Disposable subscriptionOpenMediaPreviewEvent = RxBus.getDefault().toObservable(OpenMediaPreviewFragmentEvent.class)
                .map(new Function<OpenMediaPreviewFragmentEvent, OpenMediaPreviewFragmentEvent>() {
                    @Override
                    public OpenMediaPreviewFragmentEvent apply(OpenMediaPreviewFragmentEvent mediaPreviewEvent) throws Exception {
        ...
        Disposable subscriptionMediaViewPagerChangedEvent = RxBus.getDefault().toObservable(MediaViewPagerChangedEvent.class)
                .map(new Function<MediaViewPagerChangedEvent, MediaViewPagerChangedEvent>() {
                    @Override
                    public MediaViewPagerChangedEvent apply(MediaViewPagerChangedEvent event) throws Exception {
                        return event;
                    }
                })
